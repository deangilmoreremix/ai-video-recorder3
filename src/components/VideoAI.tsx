...
interface VideoAIFeature {
  id: string;
  enabled: boolean;
}

interface VideoAIProps {
  feature: VideoAIFeature;
  handleAIFeatureToggle: (id: string) => void;
}

export const VideoAI: React.FC<VideoAIProps> = ({ feature, handleAIFeatureToggle }) => {
  return (
    <>
      {/* AI feature button */}
      <button
