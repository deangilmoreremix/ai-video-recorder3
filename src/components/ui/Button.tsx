...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-[#E44E51] hover:bg-[#D43B3E] text-white shadow-lg hover:shadow-[#E44E51]/25",
  ...
  return (
    ...
    >
      {isLoading ? (
        <>
          <svg aria-hidden="true" focusable="false" className="animate-spin -ml-1 mr-2 h-4 w-4 text-current" fill="none" viewBox="0 0 24 24">
