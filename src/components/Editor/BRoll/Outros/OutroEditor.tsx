    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          ...
          >
            {text.title || 'Thanks for Watching!'}
          </motion.h1>
          ...
          >
            {text.subtitle || 'Don\'t forget to subscribe'}
          </motion.h2>
          ...
          >
            {text.endMessage || 'See you in the next video!'}
          </motion.p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={text.endMessage}
                  onChange={(e) => setText({ ...text, endMessage: e.target.value })}
                  className="w-full rounded-lg border-gray-300 shadow-sm"
