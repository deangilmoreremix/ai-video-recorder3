      ...
      <header className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <span className="py-2 px-4 text-[#E44E51] font-medium border-b-2 border-[#E44E51]">
              My Recordings
            </span>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {selectedFolder && (
          <div className="mb-4 flex items-center text-sm text-gray-600">
            <Link to="/recordings" className="hover:text-[#E44E51]" onClick={() => setSelectedFolder(null)}>All Recordings</Link>
        ...
        <AnimatePresence>
          {selectedRecording && (
            <motion.div
              ...
              className="fixed bottom-0 inset-x-0 bg-white border-t border-gray-200 shadow-lg z-10"
            >
                ...
                <div className="flex space-x-3">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      ...
                      if (recording) {
                        // This would typically navigate to the edit page
                        alert(`Edit ${recording.title}`);
                      }
                    }}
                  >
                    <Edit2 className="w-4 h-4 mr-2" />
